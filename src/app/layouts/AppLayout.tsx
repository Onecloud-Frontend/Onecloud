    ...
    <TooltipProvider>
      <div className="flex h-screen overflow-hidden bg-surface-50">
        ...
        >
          ...
          <div
            className={cn(
              "h-16 flex items-center px-4 border-b border-surface-800",
          ...
          >
            {isCollapsed ? (
              ...
              <span className="text-lg font-bold text-white truncate px-2">
                OneCloud{" "}
                <span className="text-brand-400 font-medium">{moduleName}</span>
              </span>
            )}
            ...
            <button
              ...
              className={cn(
                ...
                isCollapsed &&
                  "absolute top-16 right-[-14px] bg-surface-900 border border-surface-700 h-7 w-7 rounded-full z-50 hidden",
              )}
            ...
            <div className="space-y-1">
              {currentNav.map((item) => {
                const linkContent = (
                  ...
                  >
                    <item.icon
                      className="h-[20px] w-[20px] opacity-80 shrink-0"
                      strokeWidth={2}
                    />
                    {!isCollapsed && (
                ...
                if (isCollapsed) {
                  return (
                    <Tooltip key={item.path} delayDuration={0}>
                      ...
                      <TooltipContent
                        side="right"
                        className="bg-surface-800 border-surface-700 text-white font-medium text-xs ml-2"
                      >
                        {item.label}
                      </TooltipContent>
                    </Tooltip>
